package com.dotran.oms.core.web.interceptor;
...
public class RequestResponseLoggingFilter extends OncePerRequestFilter {
    ...
    @PostConstruct
    private void init() {
        sensitiveHeadersLower = props.getSensitiveHeaders().stream().map(String::toLowerCase).collect(Collectors.toSet());
        sensitiveQueryParamsLower = props.getSensitiveQueryParams().stream().map(String::toLowerCase).collect(Collectors.toSet());
    }
